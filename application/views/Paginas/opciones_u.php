...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "opciones_l.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $updateGoTo .= (strpos($updateGoTo, '?')) ? "&" : "?";
    $updateGoTo .= $_SERVER['QUERY_STRING'];
  }
  echo '<script>alert("Registo Procesado");</script>';
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right"><strong>Porcentaje:</strong></td>
      <td><input type="text" name="fvalor_o" value="<?php echo htmlentities($row_opciones['fvalor_o'], ENT_COMPAT, 'iso-8859-1'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><a href="opciones_l.php?tipo=1">Atr&aacute;s</a></p>
</body>
</html>
<?php
