...
mysql_select_db($database_cooperativa, $cooperativa);
$query_creditos = "select idCredito,tipoCredito,montototal,numeropagos,estado,fechaCredito, concat(apellidoPersonal,' ',nombrePersonal) as cliente, cedulaPersonal from creditos c inner join personal p  on p.idPersonal=c.idPersonal where estado='Vigente' order by fechaCredito desc";
...
<thead>
  ...
  <?php do { ?>
    <tr>
      ...
      <td nowrap><?php echo $row_creditos['cedulaPersonal']; ?></td>
      <td><?php echo $row_creditos['cliente']; ?></td>
      <td><?php echo $row_creditos['montototal']; ?></td>
      <td><?php echo $row_creditos['estado']; ?></td>
      <td><a href="creditos_ppc.php?idc=<?php echo $row_creditos['idCredito']; ?>"><img src="../images/b_browse.png" width="16" height="16" /></a></td>
      </tr>
