...
mysql_select_db($database_cooperativa, $cooperativa);
$query_opciones = sprintf("SELECT * FROM opciones WHERE tipo_o = %s", GetSQLValueString($colname_opciones, "text"));
...
<body>
<h1><?php echo $row_opciones['tipo_o']; ?></h1>
<table width="100%" border="0" cellspacing="5" cellpadding="5">
  <tr>
    <td><table align="center" cellpadding="2" cellspacing="2" class="display" id="example">
      <tr>
        <th align="center">Descripci&oacute;n</th>
        <td align="center"><a href="opciones_i.php?tipo=<?php echo $row_opciones['tipo_o']; ?>"><img src="../images/b_insrow.png" width="16" height="16" /></a></td>
      </tr>
      <?php do { ?>
      <tr>
        <td><?php echo $row_opciones['cvalor_o']; ?></td>
        <td><a href="opciones_ut.php?idO=<?php echo $row_opciones['idO']; ?>">Editar</a></td>
      </tr>
