...
$query_planpagos = sprintf("SELECT pp.*,rp.idRegistroPagos FROM planpagos pp left join registropagos rp on pp.idPlanPago=rp.idPP  WHERE idCredito =  %s", GetSQLValueString($colname_planpagos, "int"));
...
<table width="75%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><strong>Cooperativa de Ahorro y Credito 8 de Agosto</strong>
      ...
      <table width="100%" border="1" align="center">
        ...
        <tr align="center">
          ...
          <td><?php if($row_planpagos['idRegistroPagos']<>null){?><a href="creditoReciboPago.php?idRP=<?php echo $row_planpagos['idRegistroPagos']==null?"-1":$row_planpagos['idRegistroPagos']; ?>"><?php echo $row_planpagos['idRegistroPagos']==null?"Pendiente":"Pagado"; ?></a><?php } else {echo "Pendiente"; }?></td>
        </tr>
