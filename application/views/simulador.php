...
form.resultado.value=equivalencia+" Dólares"; <!-- devolvemos el resultado de la operacion -->
...
<form name="entrada">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
    <tr>
      <td width="11%">&nbsp;</td>
      <td width="31%" align="right"><img src="images/sim.jpg" width="107" height="94" /></td>
      <td width="56%"><h2>Simulador de Crédito</h2></td>
      <td width="2%">&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="2"><table width="100%" border="0" cellpadding="3" cellspacing="1" class="tf08">
        <tbody>
          ...
          <tr bgcolor="#DEF2FE">
            <td align="right" class="cf53"><strong>Interés %:</strong></td>
            <td valign="middle" bgcolor="#DEF2FE" class="cf54"><span id="sprytextfield3">
            <input type="text" name="tipo" value="<?php echo $row_interes['fvalor_o']; ?>" size="20" style="border:1px solid #336699; background-color: #EEEEEE" />
            <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no válido.</span></span></td>
